    ...
    <React.Fragment>
      <Grid container style={{ width: '1500px !important' }}>
        ...
        <Grid item xs={12}>
          ...
          >
            <BootstrapDialogTitle id="customized-dialog-title" onClose={toggleForgotPassModal} className="toolHeader" style={{ textAlign: 'center', backgroundColor: '#262673', color: 'white' }}>
              FORGOT PASSWORD
            </BootstrapDialogTitle>
